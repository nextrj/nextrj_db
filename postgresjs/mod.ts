...
import { QueryTemplate } from '../mod.ts'
 ...
 * }
 * const partialQuery = toQuery(sql, queryTemplate)
 ...
 * ```
 */
export function toQuery(sql: postgres.Sql, template: QueryTemplate): postgres.PendingQuery<postgres.Row[]> {
